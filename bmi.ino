...
#define BMI270_ACEL_DATA_READY 0x80
#define BMI270_ACEL_X_LSB_REG 0x0C
#define BMI270_ACEL_X_MSB_REG 0x0D
#define BMI270_ACEL_Y_LSB_REG 0x0E
#define BMI270_ACEL_Y_MSB_REG 0x0F
#define BMI270_ACEL_Z_LSB_REG 0x10
#define BMI270_ACEL_Z_MSB_REG 0x11
...
void setup()
{
  ...
  if (id != BMI270_ID)
  {
    Serial.println("BMI270 sensor not found!");
    Serial.print("id: ");
    Serial.println(id);
    Serial.print("BMI270_ID: ");
    Serial.println(BMI270_ID);
    while (1);
  }

  Wire.write(bmi270_config_file, sizeof(bmi270_config_file));
...
void loop()
{
  ...
  Wire1.beginTransmission(BMI270_ADDRESS);
  Wire1.write(BMI270_ACEL_X_LSB_REG);
  Wire1.endTransmission(false);
  Wire1.requestFrom(BMI270_ADDRESS, 1);
  ...
  Wire1.beginTransmission(BMI270_ADDRESS);
  Wire1.write(BMI270_ACEL_X_MSB_REG);
  Wire1.endTransmission(false);
  Wire1.requestFrom(BMI270_ADDRESS, 1);
  while (Wire1.available() == 0);
  x_MSB = Wire1.read();
